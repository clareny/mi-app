...
const translations = {
  es: {
    ...
    home: {
      pitchBefore: '¿Encontraste el beat perfecto? pero la licencia exclusiva no está disponible? Hagamos el ',
      pitchRemake: 'remake',
      remakeAria: 'Ir a servicios: remake',
      pitchMid: ' que necesitas y ',
      pitchMix: 'mezclemos tu voz.',
      mixAria: 'Ir a servicios: mezcla vocal',
    },
    reviews: {
      label: 'Opiniones de Google',
      google: 'Google',
      empty: 'Todavía no hay opiniones en Google. La primera aparece acá y las siguientes se deslizan.',
      write: 'Dejar opinión',
    },
    mix: {
      eyebrow: '',
    ...
    contact: {
      ...
      tooShort: 'Contame un poco más el proyecto, sin links raros.',
      blocked: 'Ese mensaje no se puede enviar. Sacá promociones o enlaces acortados y escribime el tema.',
      openingWa: 'Abriendo WhatsApp con tu mensaje...',
      sent: 'Listo. El mensaje ya salió por correo.',
      confirmOnce: 'FormSubmit te mandó un mail de confirmación. Abrilo y confirmá una sola vez. Después los mensajes llegan solos, no hace falta volver a enviar.',
  ...
  en: {
    ...
    home: {
      pitchBefore: 'Found the perfect beat? But the exclusive license is not available? Let’s make the ',
      pitchRemake: 'remake',
      remakeAria: 'Go to services: remake',
      pitchMid: ' you need and ',
      pitchMix: 'mix your voice.',
      mixAria: 'Go to services: vocal mix',
    },
    reviews: {
      label: 'Google reviews',
      google: 'Google',
      empty: 'No Google reviews yet. The first one shows up here and the next ones slide.',
    ...
    contact: {
      ...
      tooShort: 'Tell me a bit more about the project, without shady links.',
      blocked: 'That message cannot be sent. Remove promo text or shortened links and tell me about the track.',
      openingWa: 'Opening WhatsApp with your message...',
      sent: 'Done. The message went out by email.',
      confirmOnce: 'FormSubmit sent a confirmation email. Open it and confirm once. After that, messages arrive on their own — no need to send again.',
